...
public class AuthorsName extends BaseTest{
    @Test
        ...
        NewsItemComponent newsItem = ecoNewsPageBL.getItemNewsByTitle("У академії IT");
        ecoNewsPageBL.scrollToWebElement(newsItem.getTitle());
        try {
            Thread.sleep(5000);
        ...
        System.out.println(newsItem.getAuthor().getText());
    }
}
